...
# def check_zoom_window_up(zoom_meeting_on: mp.Event) -> None:
def check_zoom_window_up() -> None:
    """
...
def pipeline_run(filename: str, frame_rate: float, log_queue, zoom_meeting_on_check: mp.Event()) -> None:
    """
