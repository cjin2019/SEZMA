...
if __name__ == "__main__":
    ...
    with config_file.open() as f:
        ...
        for frame in packets_per_frame:
            ...
            frame_sizes = [packet.get_packet_size() for packet in packets_per_frame[frame]]
            sizes += frame_sizes
        ...
        image_filename = args_tcpdump["output_file"][:args_tcpdump["output_file"].rindex(".")] + "_num_packets.png"
        fig.savefig(image_filename)
